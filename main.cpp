...
int main()
{
  ...
  std::unique_ptr<Particle> w_1_boson_decay_product_1=std::make_unique<Muon>(0, 1, -1, 0.5, 28, 4, 11, 15);
  std::unique_ptr<Particle> w_1_boson_decay_product_2=std::make_unique<Neutrino>(0, "muon", 1, 0, 0.5, 10, 1, 3, 6)->convert_particle();

  // Instantiating the decay products of the W+ boson
  std::unique_ptr<Particle> w_2_boson_decay_product_1=std::make_unique<Top>(0.333, "red", 0.667, 0.5, 12, 2, 1, 5)->convert_particle();
  std::unique_ptr<Particle> w_2_boson_decay_product_2=std::make_unique<Bottom>(0.333, "blue", -0.333, 0.5, 18, 6 , 12, 2);

  // Instantiating the decay products of the Higgs boson
  std::unique_ptr<Particle> higgs_decay_product_1=std::make_unique<GaugeBoson>(0, 1, "photon", 43, 13, 20, 3);
  std::unique_ptr<Particle> higgs_decay_product_2=std::make_unique<GaugeBoson>(0, 1, "photon", 20, 9, 12, 17);
  ...
  particle_catalogue["electron neutrino"]=std::make_unique<Neutrino>(0, "electron", 1, 0, 0.5, 10, 2, 2, 1);
  particle_catalogue["electron antineutrino"]=std::make_unique<Neutrino>(0, "electron", 1, 0, 0.5, 8, 1, 5, 3)->convert_particle();
  particle_catalogue["muon neutrino"]=std::make_unique<Neutrino>(0, "muon", 1, 0, 0.5, 16, 6, 5, 1);
  particle_catalogue["muon antineutrino"]=std::make_unique<Neutrino>(0, "muon", 1, 0, 0.5, 12, 2, 2, 1)->convert_particle();
  particle_catalogue["tau neutrino"]=std::make_unique<Neutrino>(0, "tau", 1, 0, 0.5, 9, 4, 3, 6);
  particle_catalogue["tau antineutrino"]=std::make_unique<Neutrino>(0, "tau", 1, 0, 0.5, 17, 7, 7, 3)->convert_particle();
  ...
  particle_catalogue["down"]=std::make_unique<Down>(0.333, "red", -0.333, 0.5, 3, 1, 1, 2);
  particle_catalogue["antidown"]=std::make_unique<Down>(0.333, "green", -0.333, 0.5, 18, 8, 6, 4)->convert_particle();
  ...
  particle_catalogue["strange"]=std::make_unique<Strange>(0.333, "red", -0.333, 0.5, 16, 6, 6, 3);
  particle_catalogue["antistrange"]=std::make_unique<Strange>(0.333, "green", -.0333, 0.5, 23, 3, 7, 7)->convert_particle();
  ...
  particle_catalogue["bottom"]=std::make_unique<Bottom>(0.333, "green", -0.333, 0.5, 30, 20, 23, 9);
  particle_catalogue["antibottom"]=std::make_unique<Bottom>(0.333, "red", -0.333, 0.5, 29, 11, 3, 2)->convert_particle();
  ...
  particle_catalogue["W+ boson"]=std::make_unique<WBoson>(std::move(w_2_boson_decay_product_1), std::move(w_2_boson_decay_product_2),
    -1, 1, 30, 2, 22, 12)->convert_particle(); //// Problem of converting and setting decay products
  particle_catalogue["photon"]=std::make_unique<GaugeBoson>(0, 1, "photon", 56, 14, 21, 11);
